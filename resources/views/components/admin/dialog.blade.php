...
<dialog
    ...
    {{ $attributes->class("m-auto w-[calc(100%-2rem)] {$sizeClass} rounded-2xl border border-border bg-white p-0 text-left text-gray-900 shadow-xl backdrop:bg-slate-950/50 whitespace-normal") }}
>
