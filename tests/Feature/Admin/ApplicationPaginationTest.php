...
class ApplicationPaginationTest extends TestCase
{
    ...
    public function test_pagination_is_stable_ten_per_page_for_every_internal_role_and_preserves_filters(): void
    {
        ...
        foreach ([$superAdmin, $manager, $staff] as $actor) {
            ...
            $response->assertOk()->assertViewHas('applications', function ($applications) use ($service): bool {
                ...
                return $applications->count() === 10
                    && $applications->total() === 11
                    && $applications->first()->application_code === 'HS-PAGE-011'
